    ...
    <section id="materiales" className="py-20" style={{ backgroundColor: "#f5e1ce" }}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          <span className="inline-block text-sm font-bold px-4 py-1 rounded-full mb-5 uppercase tracking-widest" style={{ backgroundColor: "#2f2c79", color: "#ffffff" }}>
            Recursos
          </span>
          <h2 className="text-4xl md:text-5xl font-black mb-4 leading-tight" style={{ color: "#000020" }}>
            Materiales descargables
          </h2>
          <div className="w-14 h-1.5 rounded-full mx-auto mb-5" style={{ backgroundColor: "#e8c39e" }} />
          ...
          {materiales.map(m => (
            ...
            >
              ...
              <div className="p-6 flex flex-col items-center flex-1 w-full">
                ...
                {m.url ? (
                  <a href={m.url} target="_blank" rel="noopener noreferrer" className="mt-4 text-sm font-bold transition-opacity hover:opacity-70" style={{ color: "#2f2c79" }}>
                    Descargar →
                  </a>
                ) : (
        ...
        <div className="rounded-2xl p-8 text-center" style={{ background: "linear-gradient(135deg, #000020 0%, #171a4a 50%, #2f2c79 100%)" }}>
          <p className="text-lg font-bold mb-2" style={{ color: "#f5e1ce" }}>¿Querés recibir todos los materiales por email?</p>
          <p className="text-sm mb-6 font-medium" style={{ color: "#e8c39e" }}>Sumate al compromiso y te los enviamos de forma gratuita.</p>
          <button
